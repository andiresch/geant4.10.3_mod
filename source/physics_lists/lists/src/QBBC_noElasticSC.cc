...
// ********************************************************************
//
// $Id: QBBC_noElasticSC.cc 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
...
QBBC_noElasticSC::QBBC_noElasticSC( G4int ver, const G4String&)
{
  G4DataQuestionaire it(photon, neutronxs);
  G4cout << "<<< Reference Physics List QBBC_noElasticSC "
	 <<G4endl;	
