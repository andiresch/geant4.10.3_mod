...
// ********************************************************************
//
// $Id: QBBC_noInelasticSC.cc 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
...
QBBC_noInelasticSC::QBBC_noInelasticSC( G4int ver, const G4String&)
{
  G4DataQuestionaire it(photon, neutronxs);
  G4cout << "<<< Reference Physics List QBBC_noInelasticSC "
	 <<G4endl;	
...
void QBBC_noInelasticSC::SetCuts()
{
  SetCutsWithDefault();   
}
