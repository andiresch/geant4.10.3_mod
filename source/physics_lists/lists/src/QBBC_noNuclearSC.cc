...
// ********************************************************************
//
// $Id: QBBC_noNuclearSC.cc 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
...
QBBC_noNuclearSC::QBBC_noNuclearSC( G4int ver, const G4String&)
{
  G4DataQuestionaire it(photon, neutronxs);
  G4cout << "<<< Reference Physics List QBBC_noNuclearSC "
	 <<G4endl;	
