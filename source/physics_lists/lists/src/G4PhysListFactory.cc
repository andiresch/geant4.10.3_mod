...
#include "LBE.hh"
#include "QBBC.hh"
#include "QBBC_noElasticSC.hh"
#include "QBBC_noInelasticSC.hh"
#include "QBBC_noNuclearSC.hh"
  ...
  : defName("FTFP_BERT"),verbose(1)
{
  ...
  G4String ss[25] = {
    ...
    "FTFP_INCLXX_HP","FTF_BIC", "LBE","QBBC","QBBC_noElasticSC","QBBC_noInelasticSC","QBBC_noNuclearSC",
...
G4PhysListFactory::GetReferencePhysList(const G4String& name)
{
  ...
  else if(had_name == "QBBC_noNuclearSC")           {p = new QBBC_noNuclearSC(verbose);}
  else if(had_name == "QBBC_noElasticSC")           {p = new QBBC_noElasticSC(verbose);}
  else if(had_name == "QBBC_noInelasticSC")           {p = new QBBC_noInelasticSC(verbose);}
